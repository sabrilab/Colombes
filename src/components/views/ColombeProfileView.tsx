      ...
      <main className="mx-auto max-w-5xl space-y-4 px-4 py-6 lg:px-6">
        ...
        <div className="reveal space-y-1.5" style={{ '--reveal-order': 1 } as React.CSSProperties}>
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Badge variant="secondary">{t(colombe.sector)}</Badge>
          </div>
          <p className="max-w-2xl text-sm text-muted-foreground">{t(colombe.pitch)}</p>
        </div>
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2 text-sm">
            ...
            <Badge variant="secondary">{t(PROFILE_WORDS[valuation.profileLabel])}</Badge>
          </div>
        </Card>
        ...
        <Card className="reveal gap-3 p-5" style={{ '--reveal-order': 4 } as React.CSSProperties}>
          ...
          <p className="text-xs text-muted-foreground">
            {t('The three factors that weigh most on its multiple, in points.')}
          </p>
        </Card>
