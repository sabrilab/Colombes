...
export const FR: Record<string, string> = {
  ...
  'Fastest to the goal': 'Arrive le plus vite',
  'Last touched': 'Touchée en dernier',
  'If the assumptions hold.': 'Si les hypothèses tiennent.',
  'On the current trajectory.': 'Sur la trajectoire actuelle.',
  'For picking work back up.': 'Pour reprendre un travail en cours.',
  'What is it? Who pays for it?': 'C’est quoi ? Qui paie pour ça ?',
  'Add what it is': 'Dire ce que c’est',
  'Link a repository': 'Lier un dépôt',
  'github.com/owner/repo': 'github.com/compte/depot',
  'pushed today': 'poussé aujourd’hui',
  'pushed {days}d ago': 'poussé il y a {days} j',
  'public signals unavailable': 'signaux publics indisponibles',
  remove: 'retirer',
  'goal in month {month}': 'objectif au mois {month}',
  'never reaches the goal': 'n’atteint jamais l’objectif',
  'Where are my ideas stored?': 'Où sont stockées mes idées ?',
  '{count} egg': '{count} œuf',
  '{count} eggs': '{count} œufs',
  '{count} hatched idea': '{count} éclose',
  '{count} hatched ideas': '{count} écloses',
  'given up': 'abandonnée',
  'In order': 'Dans l’ordre',

  // — Le relevé d'une idée : cinq postes, et d'où ils viennent —
  Told: 'Dite',
  'What it is, in one line.': 'Ce que c’est, en une ligne.',
  Priced: 'Prix posé',
  'A price someone would pay.': 'Un prix que quelqu’un paierait.',
  Coded: 'Codée',
  'A repository exists.': 'Un dépôt existe.',
  Alive: 'Vivante',
  'Pushed within the last month.': 'Poussée dans le dernier mois.',
  Paid: 'Payée',
  'At least one customer pays. This is what hatches it.':
    'Au moins un client paie. C’est ce qui la fait éclore.',
  measured: 'constaté',
  declared: 'déclaré',

  'Hatched · {count} paying': 'Éclose · {count} qui paient',
  'Abandoned · {reason}': 'Abandonnée — {reason}',
  'no reason given': 'sans raison donnée',
  'Egg · {done} of 5': 'Œuf · {done} sur 5',
  'Back to the nest': 'Revenir au nid',
  'People who actually pay': 'Ceux qui paient vraiment',
  'This is what hatches it.': 'C’est ce qui la fait éclore.',
  'Coming in now': 'Ce qui rentre',
  'If it holds': 'Si ça tient',
  'Pick it back up': 'La reprendre',
  'Give up on it': 'Y renoncer',
  'Why are you stopping?': 'Pourquoi vous arrêtez ?',
  Confirm: 'Confirmer',
  '{count} ideas in the nest': '{count} idées dans le nid',
  'drag a node · tap to open': 'tirez un nœud · touchez pour ouvrir',
